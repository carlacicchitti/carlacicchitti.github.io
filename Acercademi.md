...
<!-- Nueva sección para el texto alineado a la izquierda de la imagen -->
	<section style="display: flex; align-items: flex-start;">
		<div class="text-container" style="flex: 1; margin-right: 20px;">
			<header class="major">
				<h3>Mi historia</h3>
			</header>
		...
		<a href="generic.html" class="image">
			<img src="{% link assets/images/SAVE_20200807_230801.jpg %}" alt="" data-position="top center" style="max-width: 100%; height: auto;"/>
		</a>
	</section>
</section>
